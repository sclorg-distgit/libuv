...
# using old gcc produces lots of warnings
...
%{?scl:scl enable devtoolset-4 %{scl} "}
...
%changelog
* Fri Jan 20 2017 Zuzana Svetlikova <zsvetlik@redhat.com> - 1:1.9.1-1
- Update to 1.9.1
- no longer provide libev
- upgrade to dts4

* Thu May 26 2016 Zuzana Svetlikova <zsvetlik@redhat.com> - 1:1.7.5-9
- Add dts3 deps because of build warnings using old gcc
